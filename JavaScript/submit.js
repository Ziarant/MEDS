...
const closeAddModal = document.getElementById('close-addFiles-modal');
...
function closeAddFilesModal() {
    ...
    addFileModal.querySelector('div').classList.remove('scale-100');
    addFileModal.querySelector('div').classList.add('scale-95');
    document.body.style.overflow = ''; // 恢复背景滚动
}
...
closeAddModal.addEventListener('click', closeAddFilesModal);
