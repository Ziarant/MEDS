...
const changeItemsNum = document.getElementById('change-items-num')
...
// 更改单页显示数目
changeItemsNum.addEventListener('click', () => {
...
function renderCurrentPage() {
    ...
    pageData.forEach((item) => {
        ...
        row.innerHTML = `
          ...
          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" data-column="测试类型" style="display: true;">
            ${item.testName}
          </td>
