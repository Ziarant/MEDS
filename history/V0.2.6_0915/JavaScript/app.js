...
async function getVersion() {
    // 变更指示灯：
    document.getElementById('indicator').classList.remove('bg-indicator-gray')
    document.getElementById('indicator').classList.remove('bg-indicator-red')
    document.getElementById('indicator').classList.remove('bg-indicator-green')
    document.getElementById('indicator').classList.remove('blink-success')
    document.getElementById('indicator').classList.remove('blink-error')
    ...
    try{
        ...
        document.getElementById('indicator').classList.add('bg-indicator-green')
        document.getElementById('indicator').classList.add('blink-success')
        document.getElementById('indicator-label').textContent = '服务器连接成功'
    } catch (error) {
        console.error('Error fetching version:', error);
        document.getElementById('indicator').classList.add('bg-indicator-red')
        document.getElementById('indicator').classList.add('blink-error')
        document.getElementById('indicator-label').textContent = '服务器连接失败'
    }
}
